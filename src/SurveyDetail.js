...
const SurveyDetail = () => {
    ...
    return (
        <Container>
            ...
            {/* Background elements */}
            <div style={{ width: 1150, height: 736, left: 198, top: 80, position: 'absolute', background: 'white', borderRadius: 16 }} />
            <img
                src={process.env.PUBLIC_URL + '/back.png'}
                style={{ width: 1110, height: 222, left: 214, top: 152, position: 'absolute', background: 'linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.50) 100%)', borderRadius: 16 }}
            />

            {/* Points box */}
            <InfoBox points={50} color={{ paddingLeft: 8, paddingRight: 8, paddingTop: 4, paddingBottom: 4, left: 222, top: 160, position: 'absolute', background: mainColor, borderRadius }} />

            {/* Number of Questions */}
            <InfoBox points={15} color={{ ...TextStyle, paddingLeft: 16, paddingRight: 16, paddingTop: 10, paddingBottom: 10, left: 214, top: 390, position: 'absolute', background: secondaryColor }} />

            {/* Points Earned */}
            <InfoBox points={50} color={{ ...TextStyle, paddingLeft: 16, paddingRight: 16, paddingTop: 10, paddingBottom: 10, left: 419, top: 390, position: 'absolute', background: tertiaryColor }} />
