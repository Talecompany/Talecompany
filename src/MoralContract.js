    ...
    return (
        <Card style={{ position:"relative", maxWidth: '800px', margin: 'auto', top:50 }}>
            <CardContent style={{ overflowY: 'auto', maxHeight: '500px' }}>
                <Typography variant="h5" component="div" style={{fontSize: 32, fontFamily: 'Open Sans', wordWrap: 'break-word',fontWeight:900}}>
                    Terms and Conditions
                </Typography>
                {/* Insert your terms and conditions text here */}
                <Typography variant="body2" color="text.secondary" >
                    <section style={{wordWrap: 'break-word', textAlign:"left"}}>
                    <h6 style={{fontSize: 16, fontFamily: 'Open Sans',fontWeight:700, lineHeight:0}}>1. Introduction</h6>
                    ...
                    <section style={{wordWrap: 'break-word', textAlign:"left"}}>
                    <h6 style={{fontSize: 16, fontFamily: 'Open Sans',fontWeight:700, lineHeight:0}}>2. User Registration</h6>
                    ...
                    <section style={{wordWrap: 'break-word', textAlign:"left"}}>
                    <h6 style={{fontSize: 16, fontFamily: 'Open Sans',fontWeight:700, lineHeight:0}}>3. Acceptable Use</h6>
                    ...
                    <section style={{wordWrap: 'break-word', textAlign:"left"}}>
                        <h6 style={{fontSize: 16, fontFamily: 'Open Sans',fontWeight:700, lineHeight:0}}>4. Intellectual Property</h6>
                    ...
                    <section style={{wordWrap: 'break-word', textAlign:"left"}}>
                        <h6 style={{fontSize: 16, fontFamily: 'Open Sans',fontWeight:700, lineHeight:0}}>5. Privacy Policy</h6>
                    ...
                    <section style={{wordWrap: 'break-word', textAlign:"left"}}>
                        <h6 style={{fontSize: 16, fontFamily: 'Open Sans',fontWeight:700, lineHeight:0}}>6. Disclaimers and Limitations of Liability</h6>
                    ...
                    <section style={{wordWrap: 'break-word', textAlign:"left"}}>
                        <h6 style={{fontSize: 16, fontFamily: 'Open Sans',fontWeight:700, lineHeight:0}}>7. Termination</h6>
                    ...
                    <section style={{wordWrap: 'break-word', textAlign:"left"}}>
                        <h6 style={{fontSize: 16, fontFamily: 'Open Sans',fontWeight:700, lineHeight:0}}>8. Governing Law</h6>
                    ...
                    <section style={{wordWrap: 'break-word', textAlign:"left"}}>
                        <h6 style={{fontSize: 16, fontFamily: 'Open Sans',fontWeight:700, lineHeight:0}}>9. Changes to Terms</h6>
                    ...
                    <section style={{wordWrap: 'break-word', textAlign:"left"}}>
                        <h6 style={{fontSize: 16, fontFamily: 'Open Sans',fontWeight:700, lineHeight:0}}>10. Contact Information</h6>
