    ...
    return (
        <div className="App">
            <div style={{width: '100%', height: '100%', position: 'relative', background: '#EFEFEF'}}>
                ...
                <div style={{left: 276, top: 624, position: 'absolute', color: '#F9BC33', fontSize: 20, fontFamily: 'Open Sans', fontWeight: '700', wordWrap: 'break-word'}}>Quick Survey</div>
                ...
                <div style={{left: 353, top: 492, position: 'absolute', color: '#333333', fontSize: 14, fontFamily: 'Open Sans', fontWeight: '400', wordWrap: 'break-word'}}>There are no surveys at this time</div>
                <div style={{left: 847, top: 492, position: 'absolute', textAlign: 'center', color: '#333333', fontSize: 14, fontFamily: 'Open Sans', fontWeight: '400', wordWrap: 'break-word'}}>There are no live shows for you at the moment</div>
                ...
                <div style={{width: 16, height: 16, left: 690, top: 326, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/image11.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>
                <div style={{width: 16, height: 16, left: 1230, top: 326, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/image11.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>
