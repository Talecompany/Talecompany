    ...
    return (
        <div className="App1">
            ...
            <Link to={`/surveydetails/${iduser}`}>
                <div style={{width: 216, height: 54, left: 320, top: 765, position: 'absolute', textAlign: 'right'}}><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word'}}>Household Consumption<br/></span><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word'}}>(19 questions)</span>
            </div>
        </Link>
            <Link to={`/surveydetails/${iduser}`}>
            <div style={{width: 216, height: 54, left: 320, top: 922, position: 'absolute', textAlign: 'right'}}><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word'}}>Leisure and Interests<br/></span><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word'}}>(19 questions)</span>
            </div>
            </Link>
            <Link to={`/surveydetails/${iduser}`}>
                <div style={{width: 216, height: 54, left: 320, top: 1079, position: 'absolute', textAlign: 'right'}}><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word'}}>Education<br/></span><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word'}}>(19 questions)</span>
                </div>
            </Link>
            <Link to={`/surveydetails/${iduser}`}>
                <div style={{width: 216, height: 54, left: 906, top: 765, position: 'absolute', textAlign: 'right'}}><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word'}}>Automobile<br/></span><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word'}}>(19 questions)</span>
                </div>
            </Link>
            <Link to={`/surveydetails/${iduser}`}>
                <div style={{width: 216, height: 54, left: 906, top: 922, position: 'absolute', textAlign: 'right'}}><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word'}}>Consumer Foods and Beverages<br/></span><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word'}}>(19 questions)</span>
                </div>
            </Link>
            <Link to={`/surveydetails/${iduser}`}>
                <div style={{width: 216, height: 54, left: 615, top: 765, position: 'absolute', textAlign: 'right'}}><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word'}}>Occupation<br/></span><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word'}}>(19 questions)</span>
                </div>
            </Link>
            <Link to={`/surveydetails/${iduser}`}>
            ...
            <Link to={`/surveydetails/${iduser}`}>
                <div style={{width: 216, height: 54, left: 615, top: 1079, position: 'absolute', textAlign: 'right'}}><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word'}}>Consumer health<br/></span><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word'}}>(19 questions)</span>
                </div>
            </Link>
            <Link to={`/surveydetails/${iduser}`}>
                <div style={{width: 216, height: 54, left: 1195, top: 765, position: 'absolute', textAlign: 'right'}}><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word'}}>Mass Tourism<br/></span><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word'}}>(19 questions)</span>
                </div>
            </Link>
            <Link to={`/surveydetails/${iduser}`}>
                <div style={{width: 216, height: 54, left: 1195, top: 922, position: 'absolute', textAlign: 'right'}}><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word'}}>Multimedia<br/></span><span style={{color: 'white', fontSize: 14, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word'}}>(19 questions)</span>
                </div>
            </Link>
