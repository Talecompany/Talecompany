 ...
 <div style={{ alignItems: 'center',  position: 'relative', top : '17px', bottom: '16px', width: '100%', height: '944px', background: 'white', borderRadius: '16px', marginTop: '19px'}}>       
   ...
   <div>
    ...
    <div style={{position: 'absolute', top: '179px', right: '450px', left: '110px', bottom: '746px'}}>
                                 <div style={{color: '#111111', width: '100%',fontSize: '14px', fontFamily: 'Revert', fontWeight: '700', wordWrap: 'break-word', textAlign: 'left'}}>Survey Participation</div>
                                 </div>
    ...
    <div style={{position: 'absolute', top: '286px', right: '450px', left: '110px', bottom: '639px'}}>
                                    <div style={{color: '#111111', width: '100%',fontSize: '14px', fontFamily: 'Revert', fontWeight: '700', wordWrap: 'break-word', textAlign: 'left'}}>Focus group</div>
                                     </div>
...
<div style={{position: 'absolute', top: '394px', right: '450px', left: '110px', bottom: '531px'}}>
                                          <div style={{color: '#111111', width: '100%',fontSize: '14px', fontFamily: 'Revert', fontWeight: '700', wordWrap: 'break-word', textAlign: 'left'}}>Earning and Redeeming Point</div>
                                          </div>
