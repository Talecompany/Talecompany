...
<div style={{ width: 1220, height: 100, left: 360, top: 80, position: 'absolute', background: 'white', borderRadius: 16, display: 'flex', alignItems: 'center' }}>
  ...
  <div style={{marginTop:"300px", marginRight:"1100px",marginLeft:"-200px",flex: '1', textAlign: 'left' }}>
    ...
    <button style={{ marginTop: "300px", backgroundColor: '#00CED1', color: '#fff', border: 'none', padding: '10px', borderRadius: '10px', width: '100px', textAlign: 'center' }} onClick={handleNextButtonClick} disabled={!selectedEmoji} >Next</button>
                        </div>
  </div>
  </div>
</div>
...
export default DashboardSurvery9090;