...
const DashboardSurvery90 = () => {
  ...
  const handleNextButtonClick = () => {
    if (radioChoice) {
        navigate('/dashboard901'); // Navigate to /dashboard901 if choice made
    }
  };
  // Function to handle Previous button click
  const handlePreviousButtonClick = () => {
      navigate('/dashboard80'); // Always navigate to /dashboard80 on Previous button click
  };
            ...
            <div style={{ marginTop: "100px", width: 1220, height: 100, left: 300, top: 100, position: 'absolute', borderRadius: 16, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div className="question-container">
                    ...
                    <div className="buttons-container" style={{  display: 'flex', justifyContent: 'space-between', width: '100%', maxWidth: '500px' }}>
                        <div style={{marginTop:"10px", marginRight:"1000px",marginLeft:"200px",flex: '1', textAlign: 'left' }}>
                        ...
                        <div style={{ flex: '1', textAlign: 'right' }}>
                                    <button style={{marginTop:"10px", backgroundColor: '#00CED1', color: '#fff', border: 'none', padding: '10px', borderRadius: '10px', width: '100px', textAlign: 'center' }} onClick={handleNextButtonClick} disabled={!radioChoice}>Next</button>
                                </div>
                    </div>
                </div>
            </div>
...
export default DashboardSurvery90;