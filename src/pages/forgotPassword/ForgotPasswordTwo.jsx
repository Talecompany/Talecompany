...
function ForgotPasswordTwo() {
    ...
    return (
        <div className='forgotPassword'>
            ...
            <span className="forgotPasswordInfo">We have sent you an email at example@example.com. Check your inbox and follow the instructions to reset your account password</span>
